...
if "__main__" == __name__:
    ...
    if n_images > 0:
        ...
        logging.error(f"No image found in '{args.input_rgb_dir}'")
        exit(1)
    ...
    logging.info(
        ...
        f"with denoise_steps = {args.denoise_steps or pipe.default_denoising_steps}, "
    ...
    with torch.no_grad():
        for rgb_path in tqdm(rgb_filename_list, desc="Estimating depth", leave=True):
            input_image = Image.open(rgb_path) # Read input image
